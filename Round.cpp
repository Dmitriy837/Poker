#include "Round.h"
Round::Round(int count, Player** __players){
	count_players = count;
	_players = __players;
	stakes = 0;
...
//**************************************************************************************************
res_combo Round::fill_res_combo(Player*& pl){
	res_combo b;
...
//**************************************************************************************************
int Round::init_up_stakes(int i){
...
//**************************************************************************************************
void Round::agree_up_stakes(int i){
